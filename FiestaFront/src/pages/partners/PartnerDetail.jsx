...
import { 
  ...
  TrendingUp, CheckCircle, XCircle, Clock, Users,
...
const PartnerDetail = () => {
  ...
  const fetchPartnerData = async () => {
    try {
      ...
      const errorMessage = err.response?.data?.message || err.message || 'Failed to load partner details';
    ...
    return (
      <div className="p-6">
        <EmptyState
          ...
          description={error || "The partner you're looking for doesn't exist or has been removed."}
          action={{
                    ...
                    {partner.company && (
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-gray-900 dark:text-white">{partner.company}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {partner.location && (
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-gray-900 dark:text-white">{partner.location}</p>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="mt-1">
                          <Badge color={getCategoryColor(partner.type || partner.category)} className="capitalize">
                      ...
                      {partner.specialties && (
                        <div>
                          ...
                          <p className="text-gray-900 dark:text-white mt-1">{partner.specialties}</p>
                        </div>
                      )}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <p className="text-sm text-gray-600 dark:text-gray-400">Partner Cost</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600 dark:text-gray-400">Total Jobs Completed</span>
              ...
              <Card>
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600 dark:text-gray-400">Total Revenue Generated</span>
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {formatCurrency(totalRevenue)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600 dark:text-gray-400">Average per Event</span>
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {formatCurrency(averageRevenue)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-3">
                      <span className="text-sm font-medium text-gray-900 dark:text-white">Performance Score</span>
                      <span className="font-bold text-gray-900 dark:text-white">
                        {partner.rating ? `${(partner.rating * 20).toFixed(0)}%` : 'N/A'}
                      </span>
                    </div>
                  </div>
                </div>
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-600 dark:text-gray-400">
            Are you sure you want to delete <strong className="text-gray-900 dark:text-white">{partner.name}</strong>? 
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <p className="text-sm text-red-800 dark:text-red-300">
                This partner will be removed from all associated events and cannot be recovered.
              </p>
            </div>
          </div>
