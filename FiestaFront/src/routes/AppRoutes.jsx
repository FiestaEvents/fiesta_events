...
// Finance (Working)
const FinanceOverview = lazy(() => import("../pages/finance/Finance.jsx"));
const FinanceReports = lazy(() => import("../pages/finance/Reports.jsx"));
const Transactions = lazy(() => import('../pages/finance/Transactions.jsx')); 

// Tasks 
const TasksList = lazy(() => import("../pages/tasks/TasksList.jsx")); // FIX: Changed from TasksPage
const TaskBoard = lazy(() => import("../pages/tasks/TaskBoard.jsx"));
const TaskDetail = lazy(() => import("../pages/tasks/TaskDetail.jsx")); // FIX: Changed from TaskDetails
...
const SecuritySettings = lazy(() => import("../pages/settings/SecuritySettings.jsx"));
