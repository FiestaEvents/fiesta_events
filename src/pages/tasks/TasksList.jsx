  ...
  import { Plus, Search, Filter, Eye, X, Edit, Trash2, Download, Archive, Kanban as KanbanIcon, List as ListIcon, Clock, AlertCircle, User, Calendar, Tag, RotateCcw, AlertTriangle, Info } from "lucide-react";
  ...
  const TasksList = () => {
    ...
    const showConfirmation = useCallback((title, message, confirmText, type = "info", onConfirm) => {
    ...
    const handleTaskAction = useCallback((task, action) => {
      ...
      const { title, message, confirmText, type, action: performAction } = actionMessages[action];
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
          <div>
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              {showArchived ? "View and manage archived tasks" : "Manage team tasks and assignments"}{" "}
              {hasInitialLoad &&
                totalCount > 0 &&
        ...
        {showNoResults && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              No {showArchived ? 'archived ' : ''}tasks match your current search or filter criteria.
            </p>
