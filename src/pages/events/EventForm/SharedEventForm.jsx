...
import { 
  Save, ArrowRight, ArrowLeft, AlertCircle, CheckCircle
} from "lucide-react";
...
const SharedEventForm = ({ onSuccess }) => {
  ...
  const { 
    ...
    formData, setFormData, errors, validateCurrentStep,
          ...
          <div className="mb-6 animate-in slide-in-from-top-2">
            <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 rounded-r-lg shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-red-800 dark:text-red-200 text-sm">Action Required</h3>
                  <p className="text-red-600 dark:text-red-300 text-xs mt-0.5">Please fix the errors below to proceed.</p>
                </div>
              </div>
            </div>
          </div>
