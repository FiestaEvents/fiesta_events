    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sticky top-8 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="text-center mb-6">
        ...
        <div className="flex items-center justify-center gap-2 mt-3 flex-wrap">
          ...
          >
            {reminder.priority} {t('reminders.priority.label')}
          </span>
        </div>
      </div>
        ...
        {reminder.status === "active" && (
          <>
            ...
            >
              ...
              {actionLoading ? t('reminders.snoozing') : t('reminders.snooze1Hour')}
            </button>
            <button
              onClick={onComplete}
              disabled={actionLoading}
            ...
            >
              ...
              {actionLoading ? t('reminders.completing') : t('reminders.markComplete')}
            </button>
          </>
        )}
        {reminder.status === "active" && (
          ...
          >
            ...
            {actionLoading ? t('reminders.cancelling') : t('reminders.cancelReminder')}
          </button>
        )}
      </div>
    </div>
