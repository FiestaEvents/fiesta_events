          ...
          >
            ...
            <div className="flex px-2 border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex-1 py-3 text-xs font-bold uppercase tracking-wide border-b-2 transition-colors relative ${
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute ltr:right-2 rtl:left-2 bottom-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity translate-y-1 group-hover:translate-y-0 duration-200">
                          ...
                          <button 
                            onClick={(e) => { e.stopPropagation(); dismissNotification(rem._id); }}
                            className="p-1.5 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-md shadow-sm"
                            title="Dismiss"
                          >
                            <X className="w-4 h-4" />
                          </button>
            ...
            <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <button
                    onClick={(e) => { e.stopPropagation(); updatePreferences({ sound: !preferences.sound }); }}
                    className={`flex items-center gap-1.5 px-2 py-1 rounded-md text-[10px] font-bold border transition-all ${
                        preferences.sound 
                        ? "bg-white dark:bg-gray-800 border-green-200 text-green-600 shadow-sm" 
                ...
                <button
                    onClick={(e) => { e.stopPropagation(); updatePreferences({ desktop: !preferences.desktop }); }}
                    className={`flex items-center gap-1.5 px-2 py-1 rounded-md text-[10px] font-bold border transition-all ${
                        preferences.desktop 
                        ? "bg-white dark:bg-gray-800 border-blue-200 text-blue-600 shadow-sm" 
                        : "bg-gray-100 dark:bg-gray-800 border-transparent text-gray-400"
                    }`}
                >
